...
class FisioController extends BaseController
{
    ...
    public function index(request $request)
    {
        ...
        $users = User::where('role_id',Role::where('name','Fisioterapeuta')->first()->id);
    ...
    public function store(Request $request)
    {
        ...
        \DB::transaction(function () use ($request) {
            ...
            $User->role_id   = Role::where('name','Fisioterapeuta')->first()->id;
            $User->save();

            $role_user = new role_user;
            $role_user->user_id = $User->id;
            $role_user->role_id = Role::where('name','Fisioterapeuta')->first()->id;
            $role_user->save();
