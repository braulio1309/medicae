...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    timeGridPlugin: _fullcalendar_timegrid__WEBPACK_IMPORTED_MODULE_4__["default"],
    interactionPlugin: _fullcalendar_interaction__WEBPACK_IMPORTED_MODULE_5__["default"]
  },
  data: function data() {
    return {
      addEventsModal: false,
  ...
  methods: {
    ...
    bind_events: function bind_events() {
      var _this = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var dt, data, i, day, info, dateArray, currentDate, endDate;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              dt = new Date(); //pide el axios con los horarios de los fisiatras 
            ...
            case 9:
              ...
              console.log(info);
              dateArray = [];
              currentDate = moment(info.startDate);
              endDate = moment(info.endDate);
              while (currentDate <= endDate) {
                dateArray.push(currentDate.format('YYYY-MM-DD'));
                currentDate.add(1, 'days');
              }
              _this.options.events = dateArray.filter(function (date) {
                return !exceptionDates.includes(date.startTime);
              });
            case 17:
            case "end":
              return _context.stop();
