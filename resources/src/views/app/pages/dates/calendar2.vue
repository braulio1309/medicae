    ...
    <b-row v-if="!isLoading">
        <b-col md="4">
            <div class="form-group">
                ...
                <Dropdown v-model="selectedDoctor" :options="doctors"  @change="loadVacations" optionLabel="fullname" optionValue="id" placeholder="Seleccione un doctor" />
            </div>
        </b-col>
        <b-col md="4">
            <div class="form-group">
        ...
        <b-col md="4">
            <div class="form-group" v-show="selectedDoctor && selectedDate">
                <label for="time">Seleccionar Hora:</label>
                <Dropdown v-model="selectedTime" :options="availableTimes" optionDisabled="disabled" optionValue="id" optionLabel="time" placeholder="Seleccione una hora" />
            </div>
        </b-col>
        <div class="w-100">
            <Button class="p-button-rounded float-right" @click="reserveAppointment" :disabled="!selectedDoctor || !selectedDate || !selectedTime || SubmitProcessing">Reservar Cita</Button>
