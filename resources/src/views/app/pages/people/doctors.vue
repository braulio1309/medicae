<template>
    <div class="main-content">
      <breadcumb :page="$t('UserManagement')"/>
        ...
        >
          <div slot="table-actions" class="mt-2 mb-3">
            ...
            <b-button
              ...
              v-if="currentUserPermissions && currentUserPermissions.includes('doctor_add')"
            >
              <i class="i-Add"></i>
              Crear
            </b-button>
          ...
          <b-form @submit.prevent="Submit_User" enctype="multipart/form-data">
            <b-row>
              ...
              <b-col md="6" sm="12">
                  ...
                  <b-form-group :label="$t('Specialization')">
                    <b-form-input
                      aria-describedby="Email-feedback"
              ...
              <b-col md="6" sm="12">
                ...
                <b-form-group :label="$t('role')">
                    <select v-model="user.role" class="form-control" id="plan">
      ...
      Get_Users(page) {
        ...
        axios
          ...
          .then(response => {
            ...
            this.users = this.users.map(function(data) {
                return {
