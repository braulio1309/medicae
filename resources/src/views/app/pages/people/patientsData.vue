  ...
  <div class="main-content small">
    ...
    <div v-else class="row mb-4">
      ...
      <b-col sm="12" md="3" lg="3">
        <div class="card user-profile card-height mb-2" style="height: 100%;">
          <b-form @submit.prevent="updatedNote" enctype="multipart/form-data">
            <div class="card-body">
              <h6 class="font-weight-bold">Notas</h6>
              <textarea class="form-control" rows="8" placeholder="Ingresa tu texto aquí..." v-model="notes"
      ...
      <b-col md="3" sm="12" xs="12" lg="3">
        <div class="card user-profile card-height" style="max-height: 340px; overflow-y: auto;">
          <div class="card-body">
              ...
              <b-row>
                ...
                <b-col md="6">
                  <div class="card-part">
                    ...
                    <h4>Doctor</h4>
                    <p class="font-weight-bold">{{ appointment?.appointment?.doctor?.firstname }} {{
                      appointment?.appointment?.doctor?.lastname }}</p>
                ...
                <b-col md="2">
                  <div class="card-part">
                    ...
                    <button class="btn btn-primary" @click="focusTextarea(appointment)">
                      <i class="nav-icon i-Notepad"></i> Notes
                    </button>
                  </div>
                </b-col>
              </b-row>
            ...
            <b-card class="m-2" v-for="(appointment, index) in appointments_past" :key="index">
              <b-row>
                ...
                <b-col md="2">
                  <div class="card-part">
                    <!-- Contenido de la cuarta parte -->
                    <h5 class="text-primary text-center" @click="focusTextarea(appointment)"><i
                        class="nav-icon i-Notepad"></i> Notes</h5>
                  </div>
                </b-col>
              </b-row>
            </b-card>
      ...
      <b-col md="3" sm="12" xs="12" lg="3">
        <div class="card card-height">
          <div class="card-body">
            ...
            <b-table :striped="striped" :small="small" :items="items" :fields="fields">
            </b-table>
          </div>
        </div>
      </b-col>
        ...
        <b-form @submit.prevent="Submit_Recipe" enctype="multipart/form-data">
          <b-row>
              ...
              <validation-provider name="Name" v-slot="validationContext">
                <b-form-group :label="'Nombre'">
                  <b-form-input :state="getValidationState(validationContext)" aria-describedby="Name-feedback"
                    label="Name" readonly :value="Fullname"></b-form-input>
            ...
            <b-col lg="4" md="4" sm="12">
              <validation-provider name="Gender" v-slot="validationContext">
                <b-form-group :label="$t('Gender')" id="Gender-input">
                  <b-form-input label="Gender" v-model="user.gender" :state="getValidationState(validationContext)"
                    aria-describedby="Gender-feedback"></b-form-input>
            ...
            <b-col lg="12" md="12" sm="12">
              <validation-provider name="Diagnosic" v-slot="validationContext">
                <b-form-group :label="$t('Diagnosic')" id="Diagnostic-input">
                  <b-form-input label="Diagnosic" v-model="user.diagnosic" :state="getValidationState(validationContext)"
                    aria-describedby="Diagnostic-feedback"></b-form-input>
            ...
            <!-- Recipe -->
            <b-col lg="12" md="12" sm="12">
              <validation-provider name="Recipe" v-slot="validationContext">
                <b-form-group :label="$t('Recipe')" id="Recipe-input">
                  <b-form-textarea label="Recipe" v-model="user.recipe" rows="5"
                    :state="getValidationState(validationContext)" aria-describedby="Recipe-feedback"></b-form-textarea>
